...
| G | Operator/locality-aware extrapolation | **Prototype** | `theory/locality.py`, `estimators/locality_aware.py`, `experiments/11_locality_aware_proxy.py` | Heuristic proxy only; no commutator bounds; no rigorous theorem; synthetic support-size scaling | Low (v0.9+ for theory) |
